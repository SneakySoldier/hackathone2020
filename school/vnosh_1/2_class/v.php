...
<body>
	...
	<?php
		...
		<div class="shool_item">
			<img src="http://localhost/assets/school_icon.jpg" alt="" class="school_icon">
		</div>
		<div class="school_name">
			<a href="http://localhost/school/<?=$sql['2'];?>.php" style="font-size: 18px;"><?=$sql['1'];?></a>
	...
	<div class="profile">
		...
		<?php
        $school_select = mysqli_query($connect, "SELECT * FROM `users` WHERE `school` = 'vnosh1' AND `class` = '2' AND `class_value` = 'v'"); /*только ВНОШ 1*/
		...
		<div class="children_item">
			<img src="http://localhost/assets/myprofile.png" alt="" class="children_icon">
		</div>
		<div class="children_name">
			<a href="http://localhost/school/<?=$sql['2'];?>.php" style="font-size: 14px;"><?=$sql['1'];?> <?=$sql['2'];?> <?=$sql['3'];?></a>
		...
		<div class="profile_block2">
			...
			<div class="frame_image"><img src="http://localhost/assets/myprofile.png" alt="" class="image_prifle"></div>
