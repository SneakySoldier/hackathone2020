...
<body>
	...
	<div class="profile">
		...
		<?php
        $school_select = mysqli_query($connect, "SELECT * FROM `users` WHERE `school` = 'vnosh1' AND `class` = '1' AND `class_value` = 'b'"); /*только ВНОШ 1*/
		...
		<div class="children_name">
			<a href="../../../school/<?=$sql['2'];?>.php" style="font-size: 14px;"><?=$sql['1'];?> <?=$sql['2'];?> <?=$sql['3'];?></a>
